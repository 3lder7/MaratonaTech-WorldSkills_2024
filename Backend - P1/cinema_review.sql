...
CREATE TABLE `review` (
  ...
  KEY `fk_movie_review` (`movieId`),
  CONSTRAINT `fk_movie_review` FOREIGN KEY (`movieId`) REFERENCES `movie` (`id`),
  CONSTRAINT `fk_user_review` FOREIGN KEY (`userId`) REFERENCES `user` (`id`)
